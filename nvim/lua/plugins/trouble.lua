...
vim.keymap.set("n", "<leader>ll", "<cmd>Trouble diagnostics toggle<cr>", { desc = "Diagnostics (Trouble)" })
vim.keymap.set("n", "<leader>lL", "<cmd>Trouble diagnostics toggle filter.buf=0<cr>",
